import { BasicCustomer } from "@src/clients/commonTypes";
import { Charge } from "@src/clients/transactions/commonTypes";
...
export type HandlerFn<T> = (payload: T) => Promise<void | Response> | void | Response;
